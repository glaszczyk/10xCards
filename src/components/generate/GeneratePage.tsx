  ...
  const handleGenerate = async (formData: GenerateFormData) => {
    ...
    try {
      ...
      const mockFlashcards: Flashcard[] = Array.from({ length: formData.cardCount }, (_, i) => ({
        id: `temp-${Date.now()}-${i}`,
        front: `Generated question ${i + 1} from: "${formData.sourceText.substring(0, 50)}..."`,
        back: `Generated answer ${i + 1} based on the provided text. This is a sample answer that would be generated by AI.`,
        ...
        source_text_id: null, // TODO: Replace with actual source text ID when saving
        ease_factor: 2.5,
        interval: 0,
